...
import { CheckCircle, ChevronRight, ChevronRightRounded } from '@material-ui/icons';
...
return (
  <>
    ...
    <Grid className={classes.nextBtnContainer}>
      ...
      <IconButton className={classes.nextIcon} size="small" disabled={!value} onClick={ value ? handleNext : null }>
        <ChevronRightRounded />
      </IconButton>
    </Grid>
  </>
